...
description: As a Software Developer at Kalpnik, I played a pivotal role in
  engineering, contributing to the development of the web app, mobile app, and
  APIs. My projects included creating an interactive layer with three.js for
  live temple streams, enhancing web and mobile app functionalities, optimizing
...
▪ Enhanced the VR Devotee API service, optimizing media processing and additional operations within the CDN media management framework.
